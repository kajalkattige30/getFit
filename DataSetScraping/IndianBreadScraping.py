...
def scrapDataType1(page_soup):
    ...
    recipe_categories.add('Indian Breads')
...
for i in range(2):
    ...
    url = "https://www.allrecipes.com/recipes/1876/world-cuisine/asian/indian/bread/?internalSource=hub%20nav&referringId=233&referringContentType=Recipe%20Hub&linkName=hub%20nav%20daughter&clickId=hub%20nav%202&page="+str(i+1)
