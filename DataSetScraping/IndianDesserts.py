...
def scrapDataType1(page_soup):
    ...
    recipe_categories.add('Indian Desserts')
...
def scrapDataType2(page_soup):
    ...
    recipe_categories = set()
    recipe_categories.add('Indian')
    # recipe_categories.add('Breakfast')
    # recipe_categories.add('Snacks')
    recipe_categories.add('Indian Desserts')
    #scraping basic information
...
for i in range(3):
    ...
    url = "https://www.allrecipes.com/recipes/1879/world-cuisine/asian/indian/desserts/?internalSource=hub%20nav&referringId=233&referringContentType=Recipe%20Hub&linkName=hub%20nav%20daughter&clickId=hub%20nav%202&page="+str(i+1)
