...
def meal_predict():
    ...
    s2_out = subprocess.check_output([sys.executable, "C:/Users/Janhavi Dubule/Desktop/BE Project/getFit/models/be_proj_ml_algo.py"])

    #C:/Users/kkatt/Documents/BE_Project/getFit/SERVER/meal.json
    #C:/Users/Janhavi Dubule/Desktop/BE Project/getFit/SERVER/meal.json
    with open("C:/Users/Janhavi Dubule/Desktop/BE Project/getFit/models/meal.json") as f2:
        meals = json.load(f2)
    
    #C:/Users/Janhavi Dubule/Desktop/BE Project/getFit//SERVER/api/recommendation.json
    out_file = open("C:/Users/Janhavi Dubule/Desktop/BE Project/getFit//models/recommendation.json", "w") 
